...
export default function BrightnessSlider({ initial, onChange, onClose }: Props) {
  // Seedé avec la vraie valeur courante au montage (la modale se remonte à
  // chaque ouverture). L'état interne assure un retour visuel instantané ;
  // la commande réelle est debouncée côté parent.
